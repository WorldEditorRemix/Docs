...
WorldEditorRemix_MfcDebug_v58.pdb
WorldEditorRemix_MfcRelease_v58.exe
WorldEditorRemix_MfcRelease_v58.pdb
...
WorldEditorRemix_MfcDebug_x64_v58.pdb
WorldEditorRemix_MfcRelease_x64_v58.exe
WorldEditorRemix_MfcRelease_x64_v58.pdb
...
|---|---|
| `WorldEditorRemix_MfcRelease_v58.exe` | Normal editing — best performance |
| `WorldEditorRemix_MfcDebug_v58.exe` | When you need crash dumps (written to `logs\`) |
