...
WorldEditorRemix_MfcDebug_v57.exe
WorldEditorRemix_MfcDebug_v57.pdb
WorldEditorRemix_MfcRelease_v57.exe
WorldEditorRemix_MfcRelease_v57.pdb
...
```
WorldEditorRemix.ini
WorldEditorRemix_MfcDebug_x64_v57.exe
WorldEditorRemix_MfcDebug_x64_v57.pdb
WorldEditorRemix_MfcRelease_x64_v57.exe
WorldEditorRemix_MfcRelease_x64_v57.pdb
...
|---|---|
| `WorldEditorRemix_MfcRelease_v57.exe` | Normal editing — best performance |
| `WorldEditorRemix_MfcDebug_v57.exe` | When you need crash dumps (written to `logs\`) |
