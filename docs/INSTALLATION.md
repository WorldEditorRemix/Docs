...
WorldEditorRemix_MfcDebug_v56.exe
WorldEditorRemix_MfcDebug_v56.pdb
WorldEditorRemix_MfcRelease_v56.exe
WorldEditorRemix_MfcRelease_v56.pdb
...
```
WorldEditorRemix.ini
WorldEditorRemix_MfcDebug_x64_v56.exe
WorldEditorRemix_MfcDebug_x64_v56.pdb
WorldEditorRemix_MfcRelease_x64_v56.exe
WorldEditorRemix_MfcRelease_x64_v56.pdb
...
|---|---|
| `WorldEditorRemix_MfcRelease_v56.exe` | Normal editing — best performance |
| `WorldEditorRemix_MfcDebug_v56.exe` | When you need crash dumps (written to `logs\`) |
